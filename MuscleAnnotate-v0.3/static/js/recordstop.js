...
(function(window){
  ...
  var encoderWorker = new Worker('../static/js/Recordmp3js/mp3Worker.js');
      ...
      this.context.createJavaScriptNode).call(this.context,
        ...
        function uploadAudio(mp3Data){
          ...
          reader.onload = function(event){
            ...
            // console.log("Current region information");
            // console.log(ImageInfo[currentImage]["Regions"][0].path);
            // var cur_region = ImageInfo[currentImage]["Regions"][0];
