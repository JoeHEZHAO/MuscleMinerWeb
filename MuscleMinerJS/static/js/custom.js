...
(function($){
	...
	function sticky() {
		...
		$("#header-sticky #logo img").attr("src", $("#header #logo img").attr("alt")+"assets/images/cyto_logo_sticky.png");
	...
	function change_logo() {
		...
		if ($(window).width() < 1200) {
			$("#header #logo img").attr("src", $("#header #logo img").attr("alt")+"assets/images/cyto_logo.png");
		} else {
			$("#header #logo img").attr("src", $("#header #logo img").attr("alt")+"assets/images/cyto_logo.png");
		}
